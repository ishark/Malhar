...
/**
 * This is the an implementation of a Redis input operator
 * It takes in keys to fetch and emits Values stored as Maps in Redis i.e. when value datatype in Redis is HashMap
 * <p></p>
